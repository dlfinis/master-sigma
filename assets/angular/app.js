(function () {
  ...
  function( INIT,
    ...
    cfpLoadingBarProvider.spinnerTemplate = '<div style="position: fixed; top: 0px; left: 0px; background-color: rgb(52, 69, 87); color: rgb(246, 246, 246); height: 100%; width: 100%; z-index: 1040; vertical-align: middle; opacity: 0.15; text-align: center; padding-top: 5px;"><span class="fa fa-refresh fa-spin fa-2x fa-fw" style="vertical-align: middle;"></span><div style="text-align: center; color: rgb(255, 245, 245); font-weight: bold; display: inline-block;">Procesando información...</div></div>';
